...
- **Verifiability compounds the claim.** Supply-chain transparency (SBOM, signed builds, provenance) makes "you can check this" a checkable fact instead of an assertion, the same way sovereignty routing and zero-retention logging turn "we don't leak your data" into an enforced, testable behavior instead of a sentence in a README.
